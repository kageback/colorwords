...
def visualize(pipeline_name):
    ...
    viz.plot_result(exp,
                    ...
                    z_label='terms',
                    task_result_index=1)
    viz.plot_result(exp, 'gibson_cost', 'perception_noise', 'msg_dim', task_result_index=1)
    viz.plot_result(exp, 'gibson_cost', 'com_noise', 'perception_noise', task_result_index=1)
